...
public class NewEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        food.setOnClickListener(new Button.OnClickListener() {
            ...
            Log.v("NewEventActivity.java", "Clicked food -- changed to " + foodbool);
            }
        });
        ...
        sports.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.v("NewEventActivity.java", "Clicked sports -- changed to " + sportsbool);
            }
        });
        ...
        academic.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.v("NewEventActivity.java", "Clicked academic -- changed to " + acadbool);
            }
        });
        ...
        nightlife.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.v("NewEventActivity.java", "Clicked nightlife -- changed to " + nlbool);
            }
        });
        ...
        entertainment.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.v("NewEventActivity.java", "Clicked entertainment -- changed to " + enterbool);
            }
        });
        ...
        misc.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.v("NewEventActivity.java", "Clicked misc -- changed to " + miscbool);
            }
        });
...
//                Log.v("NewEventActivity.java", "Clicked to proceed to next page!");
//                Intent i = new Intent(NewEventActivity.this, New_Activity_B.class);
...
//                startActivity(i);
        ...
        timeTill.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                Log.v("NewEventActivity.java", "Changed time until to " + Integer.toString(progress) + " minutes.");
            }
        ...
        duration.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                Log.v("NewEventActivity.java", "Changed duration to " + Integer.toString(progress) + " minutes.");
            }
